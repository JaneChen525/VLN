#!/bin/bash
# R2R RL 难度评测一键部署脚本（基于 run_rxr_difficulty.sh 改）
# 用法: bash ~/janec/run_r2r_rl_difficulty.sh <JOBID> <SHARD_ID> <NUM_SHARDS>
# 示例: bash ~/janec/run_r2r_rl_difficulty.sh 290500 0 1
...
RESULT_DIR=r2r_rl_diff_shard${SHARD_ID}
