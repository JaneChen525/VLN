...
VLN_REWARD_MODE=${VLN_REWARD_MODE:-sparse_sr}
VLN_DENSE_GAMMA=${VLN_DENSE_GAMMA:-0.95}
VLN_DENSE_LAMBDA=${VLN_DENSE_LAMBDA:-0.2}
VLN_DENSE_CLIP=${VLN_DENSE_CLIP:-3.0}
ADV_ESTIMATOR=${ADV_ESTIMATOR:-grpo_trajectory}
...
SBATCH_EXPORT="ALL,EXP=$EXP,TOTAL_STEPS=$TOTAL_STEPS,VLN_REWARD_MODE=$VLN_REWARD_MODE,VLN_DENSE_GAMMA=$VLN_DENSE_GAMMA,VLN_DENSE_LAMBDA=$VLN_DENSE_LAMBDA,VLN_DENSE_CLIP=$VLN_DENSE_CLIP,ADV_ESTIMATOR=$ADV_ESTIMATOR"
